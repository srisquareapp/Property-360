...
function openInChrome(url=portals.meebhoomi){
  // Chrome on iOS: HTTPS destinations use googlechromes://.
  const scheme=/^https:/i.test(url)?"googlechromes://":"googlechrome://";
  const chromeUrl=scheme+"navigate?url="+encodeURIComponent(url);

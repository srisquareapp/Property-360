...
function openInChrome(url=portals.meebhoomi){
  // Chrome on iOS: use the googlechromes:// custom URL scheme directly.
  // Do NOT use googlechromes://navigate?url=... — that makes "navigate"
  // the hostname and causes ERR_NAME_NOT_RESOLVED.
  const target = new URL(url);
  const chromeUrl = (target.protocol === "https:" ? "googlechromes://" : "googlechrome://")
